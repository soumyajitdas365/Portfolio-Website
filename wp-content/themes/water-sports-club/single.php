				    	...
				    	<section id="post_section">
							...
							while ( have_posts() ) : the_post();
								...
								the_post_navigation( array(
									'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'water-sports-club' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'water-sports-club' ) . '</span>',
									'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'water-sports-club' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'water-sports-club' ) . '</span> ',
								) );
