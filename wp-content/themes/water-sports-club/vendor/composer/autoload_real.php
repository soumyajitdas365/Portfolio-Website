...
class Water_Sports_Club_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function water_sports_club_loadClassLoader($class)
    {
    ...
    public static function water_sports_club_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
