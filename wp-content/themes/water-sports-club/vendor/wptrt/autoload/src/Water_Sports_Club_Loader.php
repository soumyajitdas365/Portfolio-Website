...
class Water_Sports_Club_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function water_sports_club_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function water_sports_club_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function water_sports_club_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function water_sports_club_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->water_sports_club_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function water_sports_club_load( $class ) {
